      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-gray-600">
            Được tin tưởng bởi hơn 200 doanh nghiệp và tổ chức hàng đầu tại Việt
            Nam
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-16">
            <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm">
              ...
              <p className="text-gray-600 mb-6 italic">
                Giải pháp của họ đã giúp chúng tôi tối ưu hóa quy trình kinh
                doanh và tăng doanh thu 40% trong 6 tháng đầu. Đội ngũ chuyên
                nghiệp và tận tâm.
              </p>
            ...
            <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm">
              ...
              <p className="text-gray-600 mb-6 italic">
                Công nghệ hiện đại, giao diện thân thiện và dễ sử dụng. Đặc biệt
                là dịch vụ hỗ trợ 24/7 rất tuyệt vời. Rất hài lòng với sự lựa
                chọn này.
              </p>
              <div className="flex items-center gap-4">
